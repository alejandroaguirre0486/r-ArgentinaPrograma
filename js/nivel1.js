...
function restar(numero2,numero3){
...
//Tarea 
//Crear una funcion que tome como parametro el año actual y el de nacimiento y calcule la edad del usuario



function calcularEdadUsuario(añoActual,añoNacimiento){
   
añoActual=parseInt(window.prompt('¿Cual es el año actual?'));
añoNacimiento=parseInt(window.prompt('¿En que año nacio?'));
 return añoActual - añoNacimiento;

}
console.log('Su edad es ' + calcularEdadUsuario() + ' años');
...
capitalDeArgentinaBuenosAires=true;
console.log(!capitalDeArgentinaBuenosAires);
